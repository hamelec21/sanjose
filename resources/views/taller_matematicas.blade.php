...
<!--inicio de Contenido page-->
  <div class="container mx-auto">
    <h1 class="text-3xl text-center mt-10 mb-10 font-semibold uppercase">Taller de Matematicas</h1>
  </div>
  ...
  <div class="container mx-auto mt-10 mb-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div>
        <img src="{{ asset('img/taller-matematica.png') }}" class=" mb-0 px-0 mt-0">
      </div>
    ...
    <div>
      <p class="text-gray-700 text-justify mb-4 px-4">
        ...
        Quae iure rerum sed. Nobis esse minus temporibus aliquid fugit. Dolores, dolor vero.
    ...
    <div class="container mx-auto mt-10 mb-10">
      ...
      <div class=" grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div>
          <img src="{{ asset('img/taller-matematica.png') }}" class=" object-contain">
        </div>
