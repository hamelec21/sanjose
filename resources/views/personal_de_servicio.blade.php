...
<body>
    ...
    <div class="container mx-auto">
        <h1 class="text-3xl text-center mt-10 mb-10 font-semibold uppercase">Personal de Servicio</h1>
    </div>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 px-4 mb-10">
            <div class="flex border-red-900 border-2 ">
                <div>
                    <div>
                        <img src="{{ asset('img/Personal de Servicio/Alex Chaparro Barrera.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">

                        <h4 class="px-4 mb-1">Servicio Generales</h4>
                        <h4 class="px-4 uppercase">Alex Chaparro Barrera.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{ asset('img/Personal de Servicio/Daniel Cisterna Ramos.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Servicio Generales</h4>
                        <h4 class="px-4 uppercase">Daniel Cisterna Ramos</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img
                            src="{{ asset('img/Personal de Servicio/Graciela Mena Espinoza.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Servicio Generales</h4>
                        <h4 class="px-4 uppercase">Graciela Mena Espinoza.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2 ">
                <div>
                    <div>
                        <img
                            src="{{ asset('img/Personal de Servicio/Jose Carvajal Moreno.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">

                        <h4 class="px-4 mb-1">Servicio Generales</h4>
                        <h4 class="px-4 uppercase">José Carvajal Moreno.</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 px-4 mb-10">
            <div class="flex-row border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{ asset('img/Personal de Servicio/Liliana Grove Santander.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">

                        <h4 class="px-4 mb-1">Servicio Generales</h4>
                        <h4 class="px-4 uppercase">Liliana Grove Santander.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2 ">
                <div>
                    <div>
                        <img src="{{ asset('img/Personal de Servicio/Sergio Gonzalez Gallardo.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Servicio Generales</h4>
                        <h4 class="px-4 uppercase">Sergio Gónzalez Gallardo.</h4>
                    </div>
                </div>
            </div>
