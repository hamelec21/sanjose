...
<div class="container mx-auto">
    <h1 class="text-3xl text-center mt-10 mb-10 font-semibold uppercase">Departamento de historia y geografia</h1>
  </div>
  ...
  <div class="container mx-auto mt-10 mb-10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 ">
      ...
      <div>
        <img src="{{ asset('img/lenguaje.png') }}" class=" mb-0 px-0 mt-0">
      </div>
