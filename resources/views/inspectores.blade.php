...
<body>
    ...
    <div class="container mx-auto">
        <h1 class="text-3xl text-center mt-10 mb-10 font-semibold uppercase">inspectores</h1>
    </div>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 px-4 mb-10">
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{asset('img/INSPECTORES/Marisa Manzano Gamboa.jpg') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Inspectora</h4>
                        <h4 class="px-4 uppercase">Marisa Manzano Gamboa.jpg.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{asset('img/inspectores/Freddy Figueroa Ortega.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Inspector</h4>
                        <h4 class="px-4 uppercase">Freddy Figueroa Ortega.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2 ">
                <div>
                    <div>
                        <img src="{{asset('img/INSPECTORES/Judith Macaya Rore.jpg') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">

                        <h4 class="px-4 mb-1">Inspectora</h4>
                        <h4 class="px-4 uppercase">Judith Macaya Rore.</h4>
                    </div>
                </div>
            </div>
