...
<body>
    ...
    <div class="container mx-auto">
        <h1 class="text-3xl text-center mt-10 mb-10 font-semibold uppercase">Asistentes de Aulas</h1>
    </div>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 px-4 mb-10">
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{ asset('img/ASISTENTE DE AULA/Andrea Espinoza Vera.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Asistente de Aula</h4>
                        <h4 class="px-4 uppercase">Andrea Espinoza Vera.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{ asset('img/ASISTENTE DE AULA/Aranza Pulgar Herrera.jpg') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Asistente de Aula</h4>
                        <h4 class="px-4 uppercase">Aranza Pulgar Herrera.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2 ">
                <div>
                    <div>
                        <img src="{{ asset('img/ASISTENTE DE AULA/Carolina Guerrero Vega.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">

                        <h4 class="px-4 mb-1">Asistente de Aula</h4>
                        <h4 class="px-4 uppercase">Carolina Guerrero Vega.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2 ">
                <div>
                    <div>
                        <img src="{{ asset('img/ASISTENTE DE AULA/Francisca Arancibia Chacon.JPG') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">

                        <h4 class="px-4 mb-1">Asistente de Aula</h4>
                        <h4 class="px-4 uppercase">Francisca Arancibia Chacón.</h4>
                    </div>
                </div>
            </div>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 px-4 mb-10">
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{ asset('img/ASISTENTE DE AULA/Leticia Baez Lara.jpg') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Asistente de Aula</h4>
                        <h4 class="px-4 uppercase">Leticia Báez Lara.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{ asset('img/ASISTENTE DE AULA/Paola Varas Aguilera.jpg') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">
                        <h4 class="px-4 mb-1">Asistente de Aula</h4>
                        <h4 class="px-4 uppercase">Paola Varas Aguilera.</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="flex border-red-900 border-2">
                <div>
                    <div>
                        <img src="{{ asset('img/ASISTENTE DE AULA/Sara Guerra Diaz.jpg') }}">
                    </div>
                    <div class="bg-footer  text-center text-white">

                        <h4 class="px-4 mb-1">Asistente de Aula</h4>
                        <h4 class="px-4 uppercase">Sara Guerra Díaz.</h4>
                    </div>
                </div>
            </div>
