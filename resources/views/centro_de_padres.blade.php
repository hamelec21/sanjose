...
<div class="container mx-auto">
    <h1 class="text-3xl text-center mt-10 mb-10 font-semibold uppercase">Centro de Padres y Apoderados</h1>
  </div>
  ...
  <div class="container mx-auto">
    <p class="text-gray-700 text-justify mb-4 px-4">
      ...
      distinctio.
      Illo minima, nihil laboriosam corporis reiciendis explicabo culpa quas ipsum nobis? Voluptas autem cum consequatur
      ...
      Quae iure rerum sed. Nobis esse minus temporibus aliquid fugit. Dolores, dolor vero. Reiciendis nobis id, fugiat
  ...
  <div class="container mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 px-4">
      <div class="flex border-red-900 border-2">
       <div>
          <div>
            <img src="img/centro-alumnos.png">
          </div>
            <div class="bg-footer  text-center text-white">
              <h4 class="px-4 mb-1">PRESIDENTE</h4>
              <h4 class="px-4 uppercase">Lorem ipsum dolor sit amet.</h4>
            </div>
       </div>
      </div>
        ...
        <div>
           <div>
            <img src="img/centro-alumnos.png">
             ...
             <div class="bg-footer  text-center text-white">
              <h4 class="px-4 mb-1">VICE PRESIDENTE</h4>
              <h4 class="px-4 uppercase">Lorem ipsum dolor sit amet.</h4>
             </div>
        </div>
       </div>
           ...
           <div>
            <img src="img/centro-alumnos.png">
             ...
             <div class="bg-footer  text-center text-white">
              ...
              <h4 class="px-4 mb-1">TESORERO</h4>
              <h4 class="px-4 uppercase">Lorem ipsum dolor sit amet.</h4>
             </div>
        </div>
       </div>
       <div class="flex border-red-900 border-2">
        <div>
           <div>
             ...
             <div class="bg-footer  text-center text-white">
              <h4 class="px-4 mb-1">SECREATARIA</h4>
              <h4 class="px-4 uppercase">Lorem ipsum dolor sit amet.</h4>
             </div>
        </div>
       </div>
